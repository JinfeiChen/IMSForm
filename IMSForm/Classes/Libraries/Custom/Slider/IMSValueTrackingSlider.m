//
//  IMSValueTrackingSlider.m
//  IMSForm
//
//  Created by cjf on 6/1/2021.
//

#import "IMSValueTrackingSlider.h"
#import <IMSForm/IMSValuePopUpView.h>

@interface IMSValueTrackingSlider ()<IMSValuePopupViewDelegate>

@property (nonatomic, strong) NSNumberFormatter * numberFormatter;
@property (nonatomic, strong) IMSValuePopupView * popUpView;

@end

@implementation IMSValueTrackingSlider
{
...
- (void)setup {
    ...
    self.popUpView = [[IMSValuePopupView alloc] initWithFrame:CGRectZero];
