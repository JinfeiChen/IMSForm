...
@interface IMSFormCurrencyCPNConfig : IMSFormCPNConfig

@property (assign, nonatomic) NSInteger lengthLimit; /**< 文本最大输入长度限制, default 100 */
@property (assign, nonatomic) double min; /**< 最小值, e.g. 0.0 */
@property (assign, nonatomic) double max; /**< 最大值, e.g. 10.0 */
